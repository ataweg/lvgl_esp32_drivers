...
void ili9488_init(void)
{
	...
	lcd_init_cmd_t ili_init_cmds[]={
		...
		{ /* 0xB2 */ ILI9488_CMD_FRAME_RATE_CONTROL_NORMAL, {0xA0}, 1},
		...
		{ /* 0x%3 */ ILI9488_CMD_WRITE_CTRL_DISPLAY,        {0x28}, 1},
		{ /* 0x%1 */ ILI9488_CMD_WRITE_DISPLAY_BRIGHTNESS,  {0x7F}, 1},
	...
	lcd_init_cmd_t ili_init_cmds[]={
		...
		{ /* 0xF7 */ ILI9488_CMD_ADJUST_CONTROL_3,          {0xA9, 0x51, 0x2C, 0x82}, 4},
		{ /* 0x11 */ ILI9488_CMD_SLEEP_OUT,                 {0x00}, 0x80},
		{ /* 0x29 */ ILI9488_CMD_DISPLAY_ON,                {0x00}, 0x80},
		{0, {0}, 0xff},
	};
