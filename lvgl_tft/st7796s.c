...
void st7796s_init(void)
{
	...
	lcd_init_cmd_t init_cmds[] = {
		...
		// {0x2C, {0}, 0},
		// {0x2A, {0x00, 0x00, 0x01, 0x3F /* 0xDF */}, 4},
        // {0x2B, {0x00, 0x00, 0x01, 0xDF /* 0x3F */}, 4},
        // {0x2C, {0}, 0},
...
void st7796s_flush(lv_disp_drv_t *drv, const lv_area_t *area, lv_color_t *color_map)
{
	...
	// TODO: 不知道 lv_disp_flush_ready要放在st7796s_send_color前面还是后面
...
static void st7796s_send_cmd(uint8_t cmd)
{
	// TODO: disp_wait_for_pending_transactions
