...
#define TFT_SPI_HOST /* SPI3_HOST */SPI3_HOST/* VSPI_HOST */
#elif defined (CONFIG_LV_TFT_DISPLAY_SPI_FSPI)
#define TFT_SPI_HOST /* SPI3_HOST */SPI3_HOST/* FSPI_HOST */
#endif
...
#define TOUCH_SPI_HOST SPI3_HOST/* FSPI_HOST */
#endif
...
#else
#define SPI_BUS_MAX_TRANSFER_SZ (DISP_BUF_SIZE * /* 3 */2)
#endif
